...
try:
    from geonode_workshop.local_settings import *
except ImportError:
    from geonode_workshop.settings import *
...
def _reset():
    ...
    sh(f"rm -rf {path}")
    sh("rm -rf geonode_workshop/development.db")
    sh("rm -rf geonode_workshop/uploaded/*")
    _configure_data_dir()
